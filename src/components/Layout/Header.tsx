...
import { NAVIGATION_ITEMS, APP_NAME, TOUR_CATEGORIES } from "../../constants/constants";
...
const Header = memo(({
   ...
   */
  const handleMegaMenuOpen = useCallback((itemId: string) => {
              ...
              >
                {NAVIGATION_ITEMS.map((item) => {
                  ...
                  return (
                    <Box
                      key={item.id}
                      onMouseEnter={() => hasMegaMenu && handleMegaMenuOpen(item.id)}
                      onMouseLeave={() => hasMegaMenu && handleMegaMenuClose()}
                    ...
                    >
                      <Button
                        ...
                        aria-expanded={hasMegaMenu ? isMegaMenuOpen : undefined}
                        aria-haspopup={hasMegaMenu ? "true" : undefined}
                        endIcon={hasMegaMenu ? <IconChevronDown size={16} /> : undefined}
                        sx={{
                          textTransform: "none",
